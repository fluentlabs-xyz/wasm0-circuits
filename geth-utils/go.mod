...
require (
	...
	github.com/wasm0/zkwasm-gas-injector v0.0.0-20230411142508-c7b0f5abfee3 // indirect
	github.com/wasm0/zkwasm-wasmi v0.0.0-20230408223130-a0ba8afbc84e // indirect
