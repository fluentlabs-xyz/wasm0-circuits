...
use super::*;
use crate::delph_circuit::circuits::config::IMTABLE_COLUMNS;
use crate::delph_circuit::circuits::CircuitConfigure;
use crate::delph_circuit::circuits::Lookup;
use halo2_proofs::plonk::Advice;
use halo2_proofs::plonk::Column;
use halo2_proofs::plonk::ConstraintSystem;
use crate::delph_circuit::specs::mtable::AccessType;
use crate::delph_circuit::specs::mtable::LocationType;
...
impl<F: Field> Lookup<F> for MemoryTableConfig<F> {
    fn encode(
        &self,
