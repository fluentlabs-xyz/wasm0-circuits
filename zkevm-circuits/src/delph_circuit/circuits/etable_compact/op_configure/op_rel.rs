...
use eth_types::Field;
use crate::delph_circuit::specs::itable::{RelOp, OPCODE_ARG1_SHIFT};
...
impl<F: Field> EventTableOpcodeConfigBuilder<F> for RelConfigBuilder {
    fn configure(
...
impl<F: Field> EventTableOpcodeConfig<F> for RelConfig {
