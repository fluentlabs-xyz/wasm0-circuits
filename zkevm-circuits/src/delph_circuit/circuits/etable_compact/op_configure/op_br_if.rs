...
use eth_types::Field;
use crate::delph_circuit::specs::itable::OPCODE_ARG1_SHIFT;
...
impl<F: Field> EventTableOpcodeConfigBuilder<F> for BrIfConfigBuilder {
    fn configure(
...
impl<F: Field> EventTableOpcodeConfig<F> for BrIfConfig {
