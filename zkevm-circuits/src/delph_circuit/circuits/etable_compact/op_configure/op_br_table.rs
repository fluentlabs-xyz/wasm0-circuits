use super::*;
use crate::delph_circuit::circuits::{mtable_compact::encode::MemoryTableLookupEncode, utils::Context};
use halo2_proofs::{
    plonk::{Error, Expression, VirtualCells},
};
use eth_types::Field;
use crate::delph_circuit::specs;
use crate::delph_circuit::specs::encode::{opcode::encode_br_table, table::encode_br_table_entry};
use crate::delph_circuit::specs::etable::EventTableEntry;
use crate::delph_circuit::specs::mtable::VarType;
use crate::delph_circuit::specs::step::StepInfo;
...
impl<F: Field> EventTableOpcodeConfigBuilder<F> for BrTableConfigBuilder {
    fn configure(
...
impl<F: Field> EventTableOpcodeConfig<F> for BrTableConfig {
...
#[cfg(test)]
mod tests {
    use crate::delph_circuit::test::test_circuit_noexternal;
