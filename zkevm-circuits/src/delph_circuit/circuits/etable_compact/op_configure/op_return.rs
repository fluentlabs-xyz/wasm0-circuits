use super::*;
use crate::delph_circuit::circuits::jtable::expression::{
    JtableLookupEntryEncode, EID_SHIFT, FID_SHIFT, LAST_JUMP_EID_SHIFT, MOID_SHIFT,
};
use crate::delph_circuit::circuits::mtable_compact::encode::MemoryTableLookupEncode;
use crate::delph_circuit::{
...
impl<F: Field> EventTableOpcodeConfigBuilder<F> for ReturnConfigBuilder {
    fn configure(
...
impl<F: Field> EventTableOpcodeConfig<F> for ReturnConfig {
