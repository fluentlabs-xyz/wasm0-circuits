...
use num_traits::One;
use eth_types::Field;
use crate::delph_circuit::specs::itable::{BinOp, OPCODE_ARG1_SHIFT};
...
impl<F: Field> EventTableOpcodeConfigBuilder<F> for BinConfigBuilder {
    fn configure(
...
impl<F: Field> EventTableOpcodeConfig<F> for BinConfig {
