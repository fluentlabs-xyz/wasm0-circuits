...
use crate::delph_circuit::specs::{mtable::VarType, step::StepInfo};
...
impl<F: Field> EventTableOpcodeConfigBuilder<F> for MemoryGrowConfigBuilder {
    fn configure(
...
impl<F: Field> EventTableOpcodeConfig<F> for MemoryGrowConfig {
