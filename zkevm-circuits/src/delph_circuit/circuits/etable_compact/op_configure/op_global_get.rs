...
use crate::delph_circuit::specs::{encode::opcode::encode_global_get, step::StepInfo};
...
impl<F: Field> EventTableOpcodeConfigBuilder<F> for GlobalGetConfigBuilder {
    fn configure(
...
impl<F: Field> EventTableOpcodeConfig<F> for GlobalGetConfig {
