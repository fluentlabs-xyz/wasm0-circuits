use super::*;
use crate::delph_circuit::{circuits::{
...
use eth_types::Field;
use crate::delph_circuit::specs::itable::{BitOp, OPCODE_ARG1_SHIFT};
...
impl<F: Field> EventTableOpcodeConfigBuilder<F> for BinBitConfigBuilder {
    fn configure(
...
impl<F: Field> EventTableOpcodeConfig<F> for BinBitConfig {
