...
use crate::delph_circuit::specs::{encode::opcode::encode_global_set, step::StepInfo};
...
impl<F: Field> EventTableOpcodeConfigBuilder<F> for GlobalSetConfigBuilder {
    fn configure(
...
impl<F: Field> EventTableOpcodeConfig<F> for GlobalSetConfig {
