...
use crate::delph_circuit::specs::{encode::opcode::encode_conversion, mtable::VarType};
use crate::delph_circuit::specs::{etable::EventTableEntry, itable::ConversionOp};
...
impl<F: Field> EventTableOpcodeConfigBuilder<F> for ConversionConfigBuilder {
    fn configure(
...
impl<F: Field> EventTableOpcodeConfig<F> for ConversionConfig {
