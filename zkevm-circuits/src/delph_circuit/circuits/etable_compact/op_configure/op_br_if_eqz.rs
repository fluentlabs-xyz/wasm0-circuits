...
use eth_types::Field;
use crate::delph_circuit::specs::encode::opcode::encode_br_if_eqz;
...
impl<F: Field> EventTableOpcodeConfigBuilder<F> for BrIfEqzConfigBuilder {
    fn configure(
...
impl<F: Field> EventTableOpcodeConfig<F> for BrIfEqzConfig {
