...
use eth_types::Field;
use crate::delph_circuit::specs::itable::{ShiftOp, OPCODE_ARG1_SHIFT};
...
impl<F: Field> EventTableOpcodeConfigBuilder<F> for BinShiftConfigBuilder {
    fn configure(
...
impl<F: Field> EventTableOpcodeConfig<F> for BinShiftConfig {
