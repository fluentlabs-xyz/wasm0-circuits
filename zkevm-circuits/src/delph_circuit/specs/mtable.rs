...
use crate::delph_circuit::specs::imtable::InitMemoryTable;
...
impl From<crate::delph_circuit::specs::types::ValueType> for VarType {
    fn from(v: crate::delph_circuit::specs::types::ValueType) -> Self {
        match v {
            crate::delph_circuit::specs::types::ValueType::I32 => Self::I32,
            crate::delph_circuit::specs::types::ValueType::I64 => Self::I64,
        }
    }
}
