...
use crate::delph_circuit::specs::brtable::{BrTable, BrTableEntry};
use crate::delph_circuit::specs::encode::opcode::{encode_br_if_eqz, encode_br_table, encode_call, encode_call_indirect, encode_global_get, encode_global_set};
use crate::delph_circuit::specs::host_function::HostPlugin;
use crate::delph_circuit::specs::mtable::{MemoryReadSize, MemoryStoreSize};
use crate::delph_circuit::specs::types::ValueType;
