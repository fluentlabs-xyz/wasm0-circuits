...
use eth_types::{evm_types::OpcodeId, Field, StackWord, ToLittleEndian, U256};
...
impl<F: Field> ExecutionGadget<F> for ErrorWriteProtectionGadget<F> {
    ...
    fn assign_exec_step(
        ...
        let [mut gas, mut code_address, mut value] = [StackWord::zero(), StackWord::zero(), StackWord::zero()];
