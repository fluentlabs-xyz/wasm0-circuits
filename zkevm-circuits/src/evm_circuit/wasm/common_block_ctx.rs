...
#[derive(Clone, Debug)]
pub(crate) struct CommonBlockCtxGadget<F, const N_BYTES: usize> {
    same_context: SameContextGadget<F>,
    value: RandomLinearCombination<F, N_BYTES>,
}

impl<F: Field, const N_BYTES: usize> CommonBlockCtxGadget<F, N_BYTES> {
...
pub(crate) struct BlockCtxU64Gadget<F> {
    value_u64: CommonBlockCtxGadget<F, N_BYTES_U64>,
}
...
impl<F: Field> ExecutionGadget<F> for BlockCtxU64Gadget<F> {
    ...
    fn configure(cb: &mut EVMConstraintBuilder<F>) -> Self {
        let value_u64 = CommonBlockCtxGadget::construct(cb);
...
pub(crate) struct BlockCtxU160Gadget<F> {
    value_u160: CommonBlockCtxGadget<F, N_BYTES_ACCOUNT_ADDRESS>,
}
...
impl<F: Field> ExecutionGadget<F> for BlockCtxU160Gadget<F> {
    ...
    fn configure(cb: &mut EVMConstraintBuilder<F>) -> Self {
        let value_u160 = CommonBlockCtxGadget::construct(cb);
...
pub(crate) struct BlockCtxU256Gadget<F> {
    value_u256: CommonBlockCtxGadget<F, N_BYTES_WORD>,
}
...
impl<F: Field> ExecutionGadget<F> for BlockCtxU256Gadget<F> {
    ...
    fn configure(cb: &mut EVMConstraintBuilder<F>) -> Self {
        let value_u256 = CommonBlockCtxGadget::construct(cb);
