...
use crate::wasm_circuit::specs::imtable::InitMemoryTable;
...
impl From<crate::wasm_circuit::specs::types::ValueType> for VarType {
    fn from(v: crate::wasm_circuit::specs::types::ValueType) -> Self {
        match v {
            crate::wasm_circuit::specs::types::ValueType::I32 => Self::I32,
            crate::wasm_circuit::specs::types::ValueType::I64 => Self::I64,
        }
    }
}
