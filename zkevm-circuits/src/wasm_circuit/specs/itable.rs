...
use crate::wasm_circuit::specs::brtable::{BrTable, BrTableEntry};
use crate::wasm_circuit::specs::encode::opcode::{encode_br_if_eqz, encode_br_table, encode_call, encode_call_indirect, encode_global_get, encode_global_set};
use crate::wasm_circuit::specs::host_function::HostPlugin;
use crate::wasm_circuit::specs::mtable::{MemoryReadSize, MemoryStoreSize};
