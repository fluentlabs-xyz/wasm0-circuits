...
impl<F: Field> WasmAssignAwareChipV1<F> for WasmExportSectionBodyChip<F> {
...
impl<F: Field> WasmLeb128AwareChipV1<F> for WasmExportSectionBodyChip<F> {}
    ...
    pub fn configure(
        ...
        cs.create_gate("WasmExportSectionBody gate", |vc| {
            ...
            configure_transition_check(
                ...
                is_export_name_len_expr.clone() * not_q_last_expr.clone(),
                true,
            ...
            configure_transition_check(
                ...
                is_export_name_expr.clone() * not_q_last_expr.clone(),
                true,
            ...
            configure_transition_check(
                ...
                is_exportdesc_type_expr.clone() * not_q_last_expr.clone(),
                true,
                &[is_exportdesc_val],
            );
            configure_transition_check(
                ...
                is_exportdesc_val_expr.clone() * not_q_last_expr.clone(),
                true,
