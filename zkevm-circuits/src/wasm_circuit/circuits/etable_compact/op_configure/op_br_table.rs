...
use crate::wasm_circuit::specs::encode::{opcode::encode_br_table, table::encode_br_table_entry};
use crate::wasm_circuit::specs::etable::EventTableEntry;
use crate::wasm_circuit::specs::mtable::VarType;
