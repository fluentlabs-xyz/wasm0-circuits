...
mod wasm_type_section_item_tests {
    ...
    use crate::wasm_circuit::wasm_sections::r#type::test_helpers::generate_type_section_functype_bytecode;
    use crate::wasm_circuit::wasm_sections::r#type::type_item::tests::TestCircuit;
