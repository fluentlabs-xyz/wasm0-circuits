...
mod wasm_type_section_body_tests {
    ...
    use eth_types::Field;
    use crate::wasm_circuit::wasm_sections::r#type::test_helpers::generate_type_section_body_bytecode;
    use crate::wasm_circuit::wasm_sections::r#type::type_body::tests::TestCircuit;
