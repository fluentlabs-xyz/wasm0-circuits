...
mod wasm_global_section_body_tests {
    ...
    use crate::wasm_circuit::wasm_sections::global::test_helpers::{generate_wasm_global_section_body_bytecode, WasmGlobalSectionBodyDescriptor, WasmGlobalSectionBodyItemDescriptor};
    use crate::wasm_circuit::wasm_sections::global::global_body::tests::TestCircuit;
