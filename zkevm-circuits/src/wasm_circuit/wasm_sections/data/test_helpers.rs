...
mod test_helpers {
    ...
    use crate::wasm_circuit::wasm_sections::data::test_helpers::{generate_wasm_data_section_body_bytecode, WasmDataSectionBodyDescriptor, WasmDataSectionBodyItemDescriptor};
