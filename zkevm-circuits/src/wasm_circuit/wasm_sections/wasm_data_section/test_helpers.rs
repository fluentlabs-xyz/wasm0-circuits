...
/// TODO mem_segment_type{1} -> mem_segment_size_opcode{1} -> mem_segment_size+ -> WASM_EXPR_DELIMITER -> mem_segment_len+ -> mem_segment_bytes+
#[derive(Clone)]
...
// items_count+ -> item+ (mem_segment_type{1} -> mem_segment_size_opcode{1} -> mem_segment_size+ -> WASM_EXPR_DELIMITER -> mem_segment_len+ -> mem_segment_bytes+)
