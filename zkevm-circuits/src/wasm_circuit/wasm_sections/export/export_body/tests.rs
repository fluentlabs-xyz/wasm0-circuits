...
mod wasm_export_section_body_tests {
    ...
    use eth_types::Field;
    use crate::wasm_circuit::wasm_sections::export::test_helpers::{generate_wasm_export_section_body_bytecode, WasmExportSectionBodyDescriptor, WasmExportSectionBodyItemDescriptor};
    use crate::wasm_circuit::wasm_sections::export::export_body::consts::ExportDesc;
    use crate::wasm_circuit::wasm_sections::export::export_body::tests::TestCircuit;
