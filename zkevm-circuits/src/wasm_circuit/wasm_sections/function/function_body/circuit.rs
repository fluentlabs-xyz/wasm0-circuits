...
use crate::wasm_circuit::wasm_sections::function::function_body::types::AssignType;
...
impl<F: Field> WasmFunctionSectionBodyChip<F>
{
    ...
    pub fn assign(
        ...
        let q_enable = true;
        debug!(
            "function_section_body: assign at offset {} q_enable {} assign_type {:?} assign_value {} byte_val {}",
            offset,
            q_enable,
            assign_type,
            assign_value,
