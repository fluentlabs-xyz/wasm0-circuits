...
impl FromStr for OpcodeId {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        ...
        Ok(match items[0] {
            ...
            "evm_call_value" => OpcodeId::CALLVALUE,
            "evm_call_data_load" => OpcodeId::CALLDATALOAD,
            "evm_call_data_size" => OpcodeId::CALLDATASIZE,
            "evm_call_data_copy" => OpcodeId::CALLDATACOPY,
            "evm_code_size" => OpcodeId::CODESIZE,
            "evm_code_copy" => OpcodeId::CODECOPY,
            "evm_gas_price" => OpcodeId::GASPRICE,
            "evm_ext_code_size" => OpcodeId::EXTCODESIZE,
            "evm_ext_code_copy" => OpcodeId::EXTCODECOPY,
            "evm_ext_code_hash" => OpcodeId::EXTCODEHASH,
            "evm_return_data_size" => OpcodeId::RETURNDATASIZE,
            "evm_return_data_copy" => OpcodeId::RETURNDATACOPY,
            "evm_block_hash" => OpcodeId::BLOCKHASH,
            ...
            "evm_gas_limit" => OpcodeId::GASLIMIT,
            "evm_chain_id" => OpcodeId::CHAINID,
            "evm_base_fee" => OpcodeId::BASEFEE,
            "evm_storage_load" => OpcodeId::SLOAD,
            "evm_storage_store" => OpcodeId::SSTORE,
            ...
            "evm_call_code" => OpcodeId::CALLCODE,
            "evm_delegate_call" => OpcodeId::DELEGATECALL,
            "evm_create2" => OpcodeId::CREATE2,
            "evm_static_call" => OpcodeId::STATICCALL,
            "evm_revert" => OpcodeId::REVERT,
            "evm_self_destruct" => OpcodeId::SELFDESTRUCT,
            // default parse
            _ => {
