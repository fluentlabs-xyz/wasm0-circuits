...
lazy_static! {
    ...
    /// Mock BASEFEE value
    pub static ref MOCK_BASEFEE: StackWord = StackWord::zero();
     /// Mock GASLIMIT value
    pub static ref MOCK_GASLIMIT: StackWord = StackWord::from(0x2386f26fc10000u64);
    /// Mock chain ID value
    pub static ref MOCK_CHAIN_ID: Word = Word::from(1338u64);
    /// Mock DIFFICULTY value
    pub static ref MOCK_DIFFICULTY: StackWord = StackWord::from(0x200000u64);
